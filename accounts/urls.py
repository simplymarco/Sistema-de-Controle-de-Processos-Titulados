...
urlpatterns = [
    ...
    path(
        "editar_interessado/<str:pk>/",
        views.editarInteressado,
        name="editar_interessado",
    ),
    path(
        "deletar_interessado/<str:pk>/",
        views.deleteInteressado,
        name="deletar_interessado",
    ),
    ...
    path("criar_feedback/", views.criarFeedback, name="criar_feedback"),
]
