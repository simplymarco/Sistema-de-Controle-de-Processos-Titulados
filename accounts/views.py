...
def home(request):
    ...
    context = {
        "listaP": listaProcessos,
        "listaI": listaInteressados,
        "listaT": listaTerras,
...
def interessadolist(request):
    ...
    return render(
        request, "accounts/interessadolist.html", {"lista": lista, "myFilter": myFilter}
    )
...
def processolist(request):
    ...
    return render(
        request, "accounts/processolist.html", {"lista": lista, "myFilter": myFilter}
    )
...
def terralist(request):
    ...
    return render(
        request, "accounts/terras.html", {"lista": lista, "myFilter": myFilter}
    )
